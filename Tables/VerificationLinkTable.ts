...
export const verificationLinksTable = createTable({
    primaryKeys: [["code", "id"], "userId"],
...
export type VerificationTable = ExtractTypesFromCreateTable<typeof verificationLinksTable>;
